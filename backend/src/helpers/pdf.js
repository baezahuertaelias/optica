...
function createPdfDocument() {
  try {
    ...
    const tablaLentes = (data) => {
      ...
      return {
        table: {
          ...
          body: [
            ['', 'ESF', 'CYL', 'EJE', 'DP'],
            ['OD', sampleData.OD.ESF, sampleData.OD.CYL, sampleData.OD.EJE, sampleData.OD.DP],
            ['OI', sampleData.OI.ESF, sampleData.OI.CYL, sampleData.OI.EJE, sampleData.OI.DP]
          ]
        },
        margin: [0, 0, 0, 15]
      }
    ...
    const observaciones = (data) => {
      return {
        text: [{ text: 'Observaciones: ', bold: true }, { text: data || 'Sin observaciones' }],
        margin: [0, 0, 0, 50]
      }
    };
      ...
      return {
        ...
        table: {
          ...
          body: [
            [
              [
                { text: [{ text: 'Total: ', bold: true }, { text: paymentData.total }], },
                { text: [{ text: 'Abono: ', bold: true }, { text: paymentData.abono }] },
                { text: [{ text: 'Pendiente: ', bold: true }, { text: paymentData.pendiente }] }
              ], {
    ...
    let docDefinition = {
      content: [
        ...
        infoLentes({ titulo: 'Modelo de armazon: ', contenido: 'Ray-Ban RB3025' }),
        infoPago(),
      ],
