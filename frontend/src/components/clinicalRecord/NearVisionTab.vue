<template>
  <div class="grid grid-cols-1 md:grid-cols-4 gap-x-8 gap-y-4">
    ...
    <div class="space-y-2 pt-3">
      ...
      <small v-if="submitted && !refractionData.pupilarDistance" class="p-error"
        >Distancia pupilar es requerido.</small
      >
    </div>
    ...
    <div class="space-y-2 pt-3">
      <FloatLabel>
        ...
        <InputNumber
          ...
          placeholder="ADD"
          fluid
          :class="{ 'p-invalid': submitted && !refractionData.patientId }"
        />
      </FloatLabel>
      <small v-if="submitted && !refractionData.patientId" class="p-error"
        >ADD es requerido.</small
      >
    </div>
  </div>
</template>
